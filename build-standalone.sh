...
echo "=== Building standalone PHP static binary via static-php-cli (Linux x86_64) ==="
...
docker cp "$CONTAINER_NAME:/build/audio-edit-cli" "./$BINARY_NAME"
...
echo "You can run commands directly using: ./$BINARY_NAME process <files>"
